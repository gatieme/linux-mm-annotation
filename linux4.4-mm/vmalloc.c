 ...
 */
/*
 * vmalloc_32()的工作方式与vmalloc()相同，但会确保所使用的物理内存总是
 * 可以用普通32位指针寻址。如果某种体系结构的寻址能力超出基于字长计算的
 * 范围，那么这种保证就很重要。例如，在启用了PAE的IA-32系统上，就是如此。
 */
